          ...
          <router-link :to="'/expertDetail/'+data.id">
            <div class="expert-top">
              ...
              <div class="user-info">
                ...
                <img src="static/img/icon-job.png" class="img-icon margin-left-5"><span>{{data.industryName}}</span>
              </div>
            </div>
            <div class="expert-middle">
              ...
              <ul class="gray-border-icons margin-top-10 margin-bottom-10">
                <li v-for="item in data.jobTitle.split(/[,，]/g)" v-if="data.jobTitle">{{item}}</li>
              </ul>
