  ...
  <div class="page-container">
    <template v-if="data.status=='待完善'||data.status=='不通过'">
      <div class="user-info-audit">
        <div class="clearfix">
          ...
          <a class="btn col-10 btn-gray-round btn-normal" :class="agreeProtocol?'bg-white fc-theme':''" @click="check()">提交审核</a><br/>
        </div>
      </div>
    ...
    <div class="container user-info">
      <div class="user-info-top">
        <router-link to="/userInfoEdit" class="btn btn-text fc-theme" style="position: absolute;right:0;top:0;" v-if="data.status=='待完善'||data.status=='不通过'">
      ...
      <div class="user-info-detail">
        <router-link to="/aboutMeEdit" class="btn btn-text fc-theme" style="position: absolute;right:0;top:0;" v-if="data.status=='待完善'||data.status=='不通过'">
          <i class="icon-edit"></i>编辑
        </router-link>
    ...
    <div class="container user-info">
      <div class="user-info-detail">
        <router-link to="/skillEdit" class="btn btn-text fc-theme" style="position: absolute;right:0;top:0;" v-if="data.status=='待完善'||data.status=='不通过'"><i
    ...
    <div class="container user-info">
      <div class="user-info-detail">
        <router-link to="/productionAdd" class="btn btn-text fc-theme" style="position: absolute;right:0;top:0;" v-if="data.status=='待完善'||data.status=='不通过'"><i
          class="icon-add"></i>添加
        </router-link>
